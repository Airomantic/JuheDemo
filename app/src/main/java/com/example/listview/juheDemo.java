...
class JuheDemo {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="0f172348beffac0efe6b7be2b2a9d27a";

    //1.影视搜索
    public static String getRequest1(String qName) throws Exception {
        String result ="";
        String url ="http://op.juhe.cn/onebox/movie/video";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("key",APPKEY);//应用APPKEY(应用详细页查询)
        params.put("dtype","");//返回数据的格式,xml或json，默认json
        params.put("q",qName);//影视搜索名称
